...
inline C256BitMap::~C256BitMap()
{C256Memcnt-=LineWidth*Height;
delete []Buffer;Buffer=NULL;
}

void inline C256BitMap::Clear()
{int i;
 Loopi(Height* LineWidth) Buffer[i]=255; 
}

inline C256BitMap& C256BitMap::operator=(const C256BitMap&OtherPic)//算符重载
{int i;
...
void inline C256BitMap::FormatF(int w,int h)
{
BYTE BMPFileHead[54]={
0x42,0x4D,0xC6,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x36,0x04,0x00,0x00,0x28,0x00,
0x00,0x00,0x58,0x00,0x00,0x00,0x76,0x00,0x00,0x00,0x01,0x00,0x08,0x00,0x00,0x00,
...
void inline C256BitMap::Save(char*FileName)
{
...
void inline C256BitMap::Load(char*FileName)
{
